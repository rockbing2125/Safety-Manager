...
class RegulationDialog(QDialog):
    ...
    def create_basic_info_group(self):
        ...
        self.country_combo.setMinimumHeight(28)  # 设置下拉框高度
        ...
        self.custom_country_input.setMinimumHeight(28)
        ...
        self.version_input.setMinimumHeight(28)  # 设置输入框高度
        ...
        self.status_combo.setMinimumHeight(28)  # 设置下拉框高度
    ...
    def create_tag_group(self):
        ...
        self.tag_input.setMinimumHeight(28)  # 设置输入框高度
